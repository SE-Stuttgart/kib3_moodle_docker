...
if(getenv("PLUGIN_CHATBOT") == "true") {
    ...
    $ws->add_external_function_to_service("block_chatbot_count_completed_course_modules", $ws_id);
    $ws->add_external_function_to_service("block_chatbot_serach_glossary", $ws_id);
