...
sudo -u www-data php /var/www/html/admin/cli/restore_backup.php --file=/tmp/setup/data/$COURSE_BACKUP_FILE --categoryid=1 > /tmp/setup/data/restored_course_info.txt
